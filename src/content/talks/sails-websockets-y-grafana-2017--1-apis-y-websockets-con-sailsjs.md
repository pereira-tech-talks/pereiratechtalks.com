...
event:
  collection: meetups
  slug: "sails-websockets-y-grafana-2017"
language: es
duration: 25
type: talk
tags: []
...
## APIs y WebSockets con SailsJs

Charla de John Darwin Morales en el meetup «APIs y WebSockets con SailsJs && Monitoreo y visualización de datos con StatsD y Grafana» de Pereira Tech Talks.
