...
event:
  collection: meetups
  slug: "noche-de-devops-docker-y-kubernetes-2018"
language: es
duration: 25
type: talk
tags: []
...
## Participación en Noche de DevOps - Introducción a Docker y Kubernetes

Charla de Hector Jimenez en el meetup «Noche de DevOps - Introducción a Docker y Kubernetes» de Pereira Tech Talks.
