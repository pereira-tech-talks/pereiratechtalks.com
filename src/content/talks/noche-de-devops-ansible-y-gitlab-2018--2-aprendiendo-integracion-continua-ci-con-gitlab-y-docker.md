...
event:
  collection: meetups
  slug: "noche-de-devops-ansible-y-gitlab-2018"
language: es
duration: 25
type: talk
tags: []
...
## Aprendiendo Integración continua (CI) con GitLab y Docker

Charla de Carlos González en el meetup «Noche de DevOps: Intro a la automatización en Ansible && CI con GitLab y Docker» de Pereira Tech Talks.
