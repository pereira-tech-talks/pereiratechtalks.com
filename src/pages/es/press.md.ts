  ...
  const markdown = serializeGenericToMarkdown({
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          `- Formulario: ${SITE_URL}/es/contact/?reason=press`,
      ...
      },
      {
        ...
        lines: [
          `- [Sobre la comunidad](${SITE_URL}/es/about/)`,
          `- [Programas](${SITE_URL}/es/verticals/)`,
          `- [Pereira Tech Days](${SITE_URL}/es/pereira-tech-days/)`,
          `- [Patrocinadores](${SITE_URL}/es/sponsors/)`,
          `- [Contribuyentes](${SITE_URL}/es/contributors/)`,
        ],
      },
    ],
  });
