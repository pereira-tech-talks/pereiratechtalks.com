...
export const es: SiteTranslations = {
  ...
  nav: {
    ...
    openMenu: 'Abrir menú',
    solidarityMark:
      'En duelo con Colombia tras el terremoto — leer el comunicado',
  },
  ...
  aboutPage: {
    ...
    passions: [
      ...
      },
      {
        title: 'Pereira Tech Day',
        description:
          'Nuestra conferencia anual insignia — 2024 en archivo; 2026 pospuesto indefinidamente. Un día completo de keynotes, talleres y networking con ponentes internacionales y aliados locales.',
        icon: '\u{1F389}',
