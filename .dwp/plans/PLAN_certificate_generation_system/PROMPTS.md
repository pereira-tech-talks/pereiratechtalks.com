# Ready-to-Use Prompts for PLAN_certificate_generation_system

This file contains **copy-paste ready prompts** for working with this specific plan.

**Plan location:** `.dwp/plans/PLAN_certificate_generation_system/`
...
2. **Replace all instances of `PLAN_certificate_generation_system`** with the actual plan name (e.g., `PLAN_EXAMPLE_document_domain_app`)
...
```
Execute the plan at: .dwp/plans/PLAN_certificate_generation_system/README.md
...
- Never commit CERT_SIGNING_PRIVATE_KEY or real attendee CSVs\n- Validate with biome + astro:check + test; build when routes change\n- Browser-verify diploma print + QR verify flows\n- Follow ADR + privacy design in analysis_results/
...
```
RESUME the plan at: .dwp/plans/PLAN_certificate_generation_system/README.md
...
```
Check status of: .dwp/plans/PLAN_certificate_generation_system/README.md
...
```
PAUSE execution of: .dwp/plans/PLAN_certificate_generation_system/README.md
